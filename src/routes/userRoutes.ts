...
import { authUser, confirmAccount, forgotPassword, registerUser, resetPassword, revalidateJWT, updateUserPassword, updateUserProfile, userProfile } from '../controllers';
